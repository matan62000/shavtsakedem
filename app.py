...
# --- 4. עיצוב CSS המדויק (ללא הבלוק הלבן הענק) ---
...
st.markdown(f"""
    ...
    /* ביטול הרקע הלבן מהבלוק הראשי */
    [data-testid="stVerticalBlock"] {{ background-color: transparent !important; box-shadow: none !important; }}
    
    /* החלת רקע לבן רק על אלמנטים ספציפיים */
    .stExpander, .stDataFrame, div[data-testid="stMetricBlock"], .leaflet-container {{ 
    ...
    iframe {{ border-radius: 15px; overflow: hidden; }}
